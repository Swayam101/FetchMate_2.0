...
const Footer = () => {
  return (
    <div className="sm:justify-around sm:flex sm:flex-row grid grid-cols-2 grid-rows-3 my-8 sm:p-8 p-4  bg-[#fff6e9]">
      <div className="col-span-2 flex sm:flex-col items-center justify-between grow-1">
      ...
      <div className="footer-3 flex flex-col justify-between">
        <div className="footer-subheading font-medium text-xl">
          Know Us More
        </div>
        <ul className="text-base basis-4/5 flex flex-col justify-around ">
          <li>About</li>
          <li>
            <Link
              to={"https://merchant.razorpay.com/policy/N5PQq0a54C6mpm/terms"}
            >
              Terms Of Service
            </Link>
          </li>
          <li>
            <Link
              to={"https://merchant.razorpay.com/policy/N5PQq0a54C6mpm/privacy"}
            >
              Privacy Policy
            </Link>
          </li>
      ...
      <div className="footer-4 flex flex-col justify-center ">
        <ul className="text-base flex flex-col justify-around basis-4/5 sm:self-start">
          <li>
            <Link
              to={"https://merchant.razorpay.com/policy/N5PQq0a54C6mpm/refund"}
            >
          ...
          <li>
            <Link
              to={
                "https://merchant.razorpay.com/policy/N5PQq0a54C6mpm/shipping"
              }
            >
          ...
          <li>
            <Link
              to={
                "https://merchant.razorpay.com/policy/N5PQq0a54C6mpm/contact_us"
              }
            >
              Contact Us
            </Link>
